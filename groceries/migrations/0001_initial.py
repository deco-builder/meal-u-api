        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Size of the measurement unit (e.g., 100 for 100g)",
                        max_digits=6,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Price for the given measurement size",
                        max_digits=6,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "energy_per_serving",
                    models.DecimalField(
                        decimal_places=2, help_text="in kJ", max_digits=6, null=True
                    ),
                ),
                (
                    "protein_per_serving",
                    models.DecimalField(
                        decimal_places=2, help_text="in grams", max_digits=6, null=True
                    ),
                ),
                (
                ...
                (
                    "sodium_per_serving",
                    models.DecimalField(
                        decimal_places=2, help_text="in mg", max_digits=6, null=True
                    ),
                ),
                (
                    "energy_per_100g",
