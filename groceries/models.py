...
class Product(models.Model):
    ...
    measurement_size = models.DecimalField(
        decimal_places=2, max_digits=6, null=True, help_text="Size of the measurement unit (e.g., 100 for 100g)"
    )
    price_per_measurement = models.DecimalField(
        decimal_places=2, max_digits=6, blank=True, help_text="Price for the given measurement size"
    )
